...
url_template = path_to_local_home + dataset_id + "/" + file_name

parquet_template = path_to_local_home + "/" + dataset_id + "/" + parquet_file
dataset_url = f"kaggle/{dataset_id}/{parquet_file}"
...
with DAG(
    ...
    format_to_parquet_task = PythonOperator(
        ...
        op_kwargs={
            "src_file": f"{path_to_local_home}/{dataset_id}/{file_name}",
        },
    )
